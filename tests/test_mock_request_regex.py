...
def test_per_test_regex_match():
    ...
    test_responses.responses[env.current_test] = {
        'GET_/configuration/v1/ap_settings_cli/.*': {'status': 210, 'payload': {'ok': True}, 'headers': {}}
    }
...
def test_global_regex_match():
    ...
    ok_responses['GET'] = {**prev_get, 'configuration_v1_ap_settings_cli_.*': {'status': 221, 'payload': {'ok': True}, 'url': '/configuration/v1/ap_settings_cli/{id}', "headers": {}}}
